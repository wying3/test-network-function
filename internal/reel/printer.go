...
func (p *Printer) ReelMatch(pattern string, before string, match string, arg interface{}) *Step {
...
// Returns no step; a printer does not feed steps.
func (p *Printer) ReelTimeout(arg interface{}) *Step {
    fmt.Println("(timeout)")
    return nil
}
...
// On eof, print eof.
// Returns no step; a printer does not feed steps.
func (p *Printer) ReelEof(arg interface{}) *Step {
    fmt.Println("(eof)")
    return nil
}
